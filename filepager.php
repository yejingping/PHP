...
<table width="100%"  bgcolor="#CCCCCC">
    <tr>
        <td >
            <?php
            if($page){
                $counter=file_get_contents("file.txt"); //读取txt文件内容到$counter
...
<span class="STYLE1">
<?php
echo "<a href=10.php?page=1>首页</a> ";
if($page!=1){
    echo "<a href=10.php?page=".($page-1).">上一页</a> ";
}
if($page<$page_count){
    echo "<a href=10.php?page=".($page+1).">下一页</a> ";
}
echo "<a href=10.php?page=".$page_count.">尾页</a>";
?>
</span> </td>
    </tr>
</table>
